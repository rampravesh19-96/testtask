...
import img1 from "./images/fcarouselimg.png";
import img2 from "./images/img201.jpg";
import img3 from "./images/img202.jpg";
import img4 from "./images/img203.jpg";
import img5 from "./images/img204.jpg";
import img6 from "./images/img205.jpg";
import img7 from "./images/img206.jpg";
...
const carouselData1 = [
  ...
  },
  {
    ...
    alt: "",
    heading: "Headline #2",
    subHeading1: "Explicabo deserunt culpa sit at itaque! Sint",
    subHeading2:
      "Assumenda fugiat id sunt labore dolorem dicta quo, dolorum repellendus",
  },
  {
    img: img3,
    alt: "",
    heading: "Headline #1",
    subHeading1: "Vitae ipsum nisi sit ipsa, ad incidunt",
    subHeading2:
      "Consequatur quos harum possimus necessitatibus praesentium quisquam",
  },
  {
    img: img4,
    alt: "",
    heading: "Headline #2",
    subHeading1: "Molestiae autem delectus ",
    subHeading2:
      "Laudantium culpa ratione iure provident quam quasi numquam aliquam cum",
  },
];
const carouselData2 = [
  {
...
const App = () => {
  ...
  return (
    <>
      <div className={`app ${menuOpen ? "app-ov-hidden" : ""}`} id="app">
        <Header setMenuOpenn={setMenuOpen} />
          ...
          <div className="img" style={{ backgroundImage: `url(${bluebg})` }}>
            <div className="top">
              ...
              <div className="right">
                <div style={{ width: "100%" }}>
                  <p>
                    At CaSE we do not just accept difference — we celebrate it,
                    we support it, and we thrive on it for the benefit of our
                  ...
                  <p>
                    ...
                    strive to create an environment where employees can excel
